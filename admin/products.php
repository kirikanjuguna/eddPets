        ...
        <form id="add-product-form" enctype="multipart/form-data">
            ...
            <div class="col-12">
              <div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Product Keywords <small>(eg: Heifer, Dog, Freshian)</small></label>
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <select class="form-control brand_list" name="e_brand_id">
                  <option value="">Select Pets & Horses Orientation</option>
                </select>
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
                ...
                <select class="form-control category_list" name="e_category_id">
                  <option value="">Select Pets & Horses Categories </option>
                </select>
              </div>
            </div>
            <div class="col-12">
