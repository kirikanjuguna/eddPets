...
<div class="container-fluid">
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	<div class="col-10">
      		<h2>Manage Pets & Horses Orientation</h2>
      	</div>
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_brand_modal" class="btn btn-warning btn-sm">Add Pets & Horses Orientation</a>
      	</div>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Pets & Horses Orientation</h5>
        	...
        	<div class="row">
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Pets & Horses Orientation</label>
		        		<input type="text" name="brand_title" class="form-control" placeholder="Enter Brand Name">
		        	</div>
        		</div>
        		<input type="hidden" name="add_brand" value="1">
        		<div class="col-12">
        			<button type="button" class="btn btn-primary add-brand">Add Pets & Horses Orientation</button>
        		</div>
        	</div>
      ...
      <div class="modal-body">
        <form id="edit-brand-form" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
              <button type="button" class="btn btn-primary edit-brand-btn">Update Pets & Horses Orientation</button>
            </div>
          </div>
